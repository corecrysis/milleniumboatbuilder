...
$query = "SELECT * FROM tb_user where a_id_user='$jut'";
           ...
           $query1 = "SELECT * FROM tb_gallery WHERE m_position='produk'";
        ...
        Tabel Product Category
            ...
            { ?>
                                                <tr>
                                                    ...
                                                    <form method="POST" action="delete_a_category.php" onsubmit="return confirm('Hapus kategori ini ?');">
                                                        <td>
                                                    ...
                                                    <form method="POST" action="edit_a_category.php">
                                                        <td>
