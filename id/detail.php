...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							...
							<h2>Deskripsi</h2>
							<p><?php echo $result['m_desc_id']; ?></p>							
							<hr style="height:1px;border:none;color:#333;background-color:#333;">
							<!-- Buka Tutup 1, JS nya dibawah (ID sama class gak boleh sama) -->
							<div id="showmenu2"><span class="alter">Ukuran Pokok </span><button style="background:none;border:none;" class="fa fa-plus-circle"></button></div>
							...
							<div id="showmenu3"><span class="alter">Kapasitas muat </span><button style="background:none;border:none;" class="fa fa-plus-circle"></button></div>
							...
							<div id="showmenu4"><span class="alter">Performa </span><button style="background:none;border:none;" class="fa fa-plus-circle"></button></div>
							...
							<tr>
								<td>Mesin Utama OUTBOARD MOTOR FOUR STROKE</td>
								<td><?php echo $result['m_mesin_omfs']; ?></td>
							</tr>
							<tr>
								<td>Kecepatan (100% MCR)</td>
								<td><?php echo $result['m_speed_mcr']; ?></td>
							</tr>
							<tr>
								<td>Kecepatan Jajah (80% MCR)</td>
								<td><?php echo $result['m_speedj_mcr']; ?></td>
							</tr>
							<tr>
								<td>Ketahanan / Jarak (80% MCR)</td>
								<td><?php echo $result['m_range_mcr']; ?></td>
							</tr>
							</table>
							</div>
							<hr style="height:1px;border:none;color:#333;background-color:#333;">
							<a href="<?php echo $result['m_path_teknis']; ?>" download> Spesifikasi Teknis (PDF)</a>
							<hr style="height:1px;border:none;color:#333;background-color:#333;">
							<a href="<?php echo $result['m_path_spec']; ?>" download> Spesifikasi Lengkap (PDF)</a>
							<hr style="height:3px;border:none;color:#333;background-color:#333;">
							<input id="showmenu" class="btn btn-success" type="button" value="Pesan Sekarang">
							<span class="fa fa-fw fa-shopping-cart"></span><br>
							<div class="coco" style="display:none;">Hubungi : 0813-2293-8845 atau marine@gmail.com</div>
						</div>					
					</div>	
</div>
<!----->
