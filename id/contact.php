        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 footer-agile">
                    <h3>Hubungi Kami</h3>
                    <form action="id_feedback.php" method="post">
                        <div class="form-group">
                            <p style="color:white"" class="col-2 col-form-label"">Name</p>
                            <div class="col-10">
                                <input class="form-control" type="text" name="m_nama" id="example-text-input" title="Your Name" required><small class="text-muted">  cth. Adam Johnson </small>
                            </div>
                        </div>
                        <div class="form-group">
                            <p style="color:white">Jenis Kelamin</p>
                            <div class="col-3">
                        ...
                        <div class="form-group">
                            <p style="color:white">Organisasi</p>
                            <div class="col-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="search" name="m_email" id="example-search-input" title="Your E-mail Address" required><small class="text-muted">  cth: adam@mail.com </small>
                            </div>
                        </div>
                        <div class="form-group">
                            <p style="color:white" class="col-2 col-form-label">Alamat</p>
                            <div class="col-10">
                                <input class="form-control" type="search" name="m_address" id="example-search-input" title="Your Address" required><small class="text-muted">  cth: Jl. Raya Kav.1-2 </small>
                            </div>
                        </div>
                        <div class="form-group">
                            <p style="color:white" class="col-2 col-form-label">Pesan</p>
                            <div class="col-10">
                                <textarea class="form-control" id="exampleTextarea" name="m_message" rows="3" title="Your Message" required></textarea>
                            </div>
                        </div>
                        <button type="submit" name="submit_fdback" class="btn btn-warning">Kirim</button>
                    </form>
<br>
<br>
                </div>
